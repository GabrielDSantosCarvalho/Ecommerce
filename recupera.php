...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($cont != 0) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'Jorginpinto@outlook.com'; //mudar para seu email
            $mail->Password = 'Gabriel13br'; ////mudar para senha do seu seu email
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;
            $mail->setFrom('Jorginpinto@outlook.com', 'EMAIL REC'); //mudar para seu email
            $mail->addAddress($to);
            $mail->isHTML(true);
